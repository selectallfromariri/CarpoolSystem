...
public class RegisterMenu extends javax.swing.JFrame {
   ...
   public RegisterMenu() {
    ...
    Color kuning = new Color(170, 145, 75);  
    Color ungu   = new Color(135, 95, 145);  
    Color merah = new Color (150, 70, 70);

    RoundedPanel registerDriver  = new RoundedPanel(30, kaler,  new Color(220, 220, 220));
    RoundedPanel registerPass    = new RoundedPanel(30, kaler,  new Color(220, 220, 220));
    RoundedPanel exitCard     = new RoundedPanel(30, kaler,    new Color(220, 220, 220));

    registerDriver.setLayout(new java.awt.BorderLayout());
    registerPass.setLayout(new java.awt.BorderLayout());
    ...
    registerDriver.add(jPanel2, java.awt.BorderLayout.CENTER);
    registerPass.add(jPanel4, java.awt.BorderLayout.CENTER);
    ...
    cardRow.add(registerDriver);  // Student Login
    cardRow.add(registerPass);    // Admin Login
    ...
    java.awt.Dimension cardSize = new java.awt.Dimension(230, 300);
        registerDriver.setPreferredSize(cardSize);
        registerPass.setPreferredSize(cardSize);
        registerDriver.setMaximumSize(cardSize);
        registerPass.setMaximumSize(cardSize);
        registerDriver.setMinimumSize(cardSize);
        registerPass.setMinimumSize(cardSize);
    ...
    registerDriver.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    registerDriver.addMouseListener(new java.awt.event.MouseAdapter() {
        @Override
        ...
        public void mouseEntered(java.awt.event.MouseEvent e) {
            registerDriver.setBackground(kuning);
        }
        @Override
        public void mouseExited(java.awt.event.MouseEvent e) {
            registerDriver.setBackground(kaler);
        }
    });

    registerPass.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    registerPass.addMouseListener(new java.awt.event.MouseAdapter() {
        @Override
        public void mouseClicked(java.awt.event.MouseEvent e) {
        ...
        @Override
        public void mouseEntered(java.awt.event.MouseEvent e) {
            registerPass.setBackground(ungu);
        }
        @Override
        public void mouseExited(java.awt.event.MouseEvent e) {
            registerPass.setBackground(kaler);
        }
    });   
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1368, 743));

        jPanel1.setBackground(new java.awt.Color(15, 61, 92));
        jPanel1.setPreferredSize(new java.awt.Dimension(750, 75));
        ...
        jLabel2.setText("Choose your role to get started.");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ucms/resources/pemandu.png"))); // NOI18N
        ...
        jLabel4.setText("Register as driver");

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Offer rides to passengers. Requires vehicle and license.");
        ...
        jLabel9.setText("Register as passenger");

        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Book carpool rides offer by driver.");
        jLabel10.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jButton3.setBackground(new java.awt.Color(153, 0, 153));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ucms/resources/penumpang_2.png"))); // NOI18N
