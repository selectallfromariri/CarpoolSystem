...
public class BookingRequestUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        welcomeLabel.setText("Booking Requests");
        header.add(welcomeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 220, 30));

        datelabel.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        datelabel.setForeground(new java.awt.Color(153, 153, 153));
        datelabel.setText("Approve or reject passenger requests");
        header.add(datelabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 250, 30));
